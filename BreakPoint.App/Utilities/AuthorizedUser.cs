namespace BreakPoint.App.Utilities
{
    using System;
    using System.Linq;
    ...
    public class AuthorizedUser : Attribute, IAuthorizationFilter
    {
        ...
        private string CheckIfTokenExistInDB(string token)
        {
            ...
            string connectionString = "Server =.\\SQLEXPRESS; Database = BreakPointDB; Integrated Security = True; Trusted_Connection = True; MultipleActiveResultSets = true";
